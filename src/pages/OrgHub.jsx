      ...
      <div className="card p-6">
        ...
        {loading ? (
          ...
          <div className="mt-4 space-y-3">
            <div className="border border-slate-200 rounded-xl p-4">
              <div className="font-semibold">{profileOrg.name || "Geen organisatie geselecteerd"}</div>
              <div className="text-xs text-slate-500">Organisatie gekoppeld</div>
            </div>
        ...
        {organization ? (
          <div className="mt-4 text-xs text-slate-500">
            Huidige selectie: <span className="badge">{organization.name || "Geen organisatie geselecteerd"}</span>
          </div>
        ) : null}
      </div>
    </div>
