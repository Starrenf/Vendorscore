      ...
      <header className="sticky top-0 z-20 bg-[#003A8F] text-white border-b border-[#002f70]">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <img
              src="/logo-vendorscore.png"
              alt="VendorScore"
              className="h-10 w-auto shrink-0"
            />
            <div className="min-w-0">
              <div className="font-semibold leading-5 tracking-tight truncate">
                VendorScore
              </div>
            ...
            <div className="absolute right-0 top-0 h-full w-[85%] max-w-sm bg-white text-slate-900 shadow-2xl p-4 flex flex-col">
              ...
              <div className="py-4 grid gap-2">
                {menu.map((item) => (
                  <Link
                    ...
                    onClick={() => setMobileOpen(false)}
                    className={
                      "w-full rounded-xl px-4 py-3 font-semibold border transition " +
                      (item.active
                        ? "bg-[#E8F0FB] border-[#003A8F] text-[#003A8F]"
              ...
              <div className="mt-auto pt-3 border-t border-slate-200">
                ...
                <div className="text-xs text-slate-500 mt-3">
                  Tip: voeg je organisatie toe via{" "}
                  <span className="font-mono">/join/&lt;slug&gt;</span>.
                </div>

                <div className="mt-4 pt-3 border-t border-slate-200">
                  <div className="text-xs text-slate-500 mb-2">Tekst volgt</div>
                  <div className="flex items-center gap-3">
                    <img
                      src="/logos/roc-nederland.png"
                      alt="ROC Nederland"
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto px-4 py-6 text-sm text-slate-600 grid gap-4 md:grid-cols-3 md:items-center">
          <div className="order-2 md:order-1">
            © {new Date().getFullYear()} VendorScore
          </div>

          <div className="order-1 md:order-2 flex flex-col items-start md:items-center gap-2">
            <div className="text-xs text-slate-500">Tekst volgt</div>
            <div className="flex items-center gap-3">
              <a
                href="https://www.rocnederland.nl"
                target="_blank"
